...
#include "/app/proxygen/proxygen/httpclient/samples/curl/CurlClient.h"
...
DEFINE_string(url,
              getenv("SERVER_URL") ? getenv("SERVER_URL") : "https://localhost:11003",
...
DEFINE_string(cert_path, "/app/server.crt", "Path to client certificate file");
